                    ...
                    <div class="card-body">
                        <form id="reviewForm"
                            ...
                            <div class="mb-4">
                                ...
                                <ul>
                                    <li>Provide constructive feedback focusing on both strengths and areas of improvement.
                                    </li>
                            ...
                            <div class="mb-4">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">"This presentation was well-organized, and the main points
                                        were clearly articulated. To make it even better, consider adding more real-world
                                        examples."</li>
                                    <li class="list-group-item">"You did a great job explaining the topic, but you could
                                        improve by maintaining eye contact with the audience."</li>
                                    <li class="list-group-item">"The group worked well together, and the project was very
                                        informative. Including a Q&A session would have made it even more engaging."</li>
                                </ul>
                            </div>
